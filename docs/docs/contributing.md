...
lang: en-US
title: Contributing
description: How to contribute to Posters.science
head:
  - - meta
    - name: og:image
...
- **Extraction tool issues**: [poster2json/issues](https://github.com/fairdataihub/poster2json/issues)
- **Documentation issues**: [posters-science-docs/issues](https://github.com/fairdataihub/posters-science-docs/issues)
