...
lang: en-US
title: Overview Page
description: Analytics and visualizations on the Posters.science overview page
head:
  - - meta
    - name: og:image
...
- **Registry growth**: How the number of posters in the registry has changed over time.
- **Institutions**: The most represented universities and research organizations.
- **Research domains**: A breakdown of posters by field (biomedical, engineering, social sciences, etc.).
- **Conferences**: Which conferences have the most associated posters.
...
::: tip
The overview page does not require an account. Anyone can view it to get a sense of what the poster registry contains.
:::
